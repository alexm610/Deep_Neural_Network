...
mkdir -p ./libraries/WordCopy_Accelerator_0_avalon_master_agent/
mkdir -p ./libraries/sdram_controller_s1_translator/
mkdir -p ./libraries/WordCopy_Accelerator_0_avalon_master_translator/
...
mkdir -p ./libraries/WordCopy_Accelerator_0/
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_agent.sv"                                               -work WordCopy_Accelerator_0_avalon_master_agent      -cdslib ./cds_libs/WordCopy_Accelerator_0_avalon_master_agent.cds.lib     
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_translator.sv"                                          -work WordCopy_Accelerator_0_avalon_master_translator -cdslib ./cds_libs/WordCopy_Accelerator_0_avalon_master_translator.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/wordcopy.sv"                                                                 -work WordCopy_Accelerator_0                          -cdslib ./cds_libs/WordCopy_Accelerator_0.cds.lib                         
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_conduit_bfm_0004.sv"                                                  -work dnn_accel_system_inst_vga_bfm                   -cdslib ./cds_libs/dnn_accel_system_inst_vga_bfm.cds.lib                  
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_conduit_bfm_0003.sv"                                                  -work dnn_accel_system_inst_switches_bfm              -cdslib ./cds_libs/dnn_accel_system_inst_switches_bfm.cds.lib             
